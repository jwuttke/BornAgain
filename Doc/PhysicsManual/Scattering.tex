...
%===============================================================================
\subsection{Born approximation}\label{SxDWBA}
%===============================================================================
...
At this point we need the far-field Green function~$\TGo^\infty$.
...
In Sect.~\ref{SdensityMatrix}, we have discussed how to obtain fluxes~$J$
from wave amplitudes.
With \cref{E1BornS} and \cref{EGoInfty}, we find
\begin{equation}\label{E1xsectiondef}
  \xElas
  = \frac{r^2 {|\v\Psi^\infty_\text{s}(\r)|}^2}{|\v\Phi_\si|^2}
  = \frac{1}{16\pi^2} \frac{\braket{\Phi_\si|\TV^+\v{P}\TV|\Phi_\si}}{\braket{\Phi_\si|\Phi_\si}}
\end{equation}

Let us assume that the incident wave is normalized to unity, ${|\v\Phi_\si|}^2=1$.
