...
\begin{equation}\label{EGoInfty}
  \TGo^\infty(\r,\r')
  = \left\{ \begin{array}{ll}
      g(r)\e^{-i\k_\sf\r'}                        &\text{~~~for neutrons (scalar),}\\
      \v1 g(r)\e^{-i\k_\sf\r'}                    &\text{~~~for neutrons (spinorial),}\\
      (\v1 - \v{\hat k}_\sf\otimes\v{\hat k}_\sf) g(r) \e^{-i\k_\sf\r'} &\text{~~~for X-rays.}
  \end{array}\right.
\end{equation}
