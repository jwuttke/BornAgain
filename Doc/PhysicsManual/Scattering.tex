...
\begin{equation}\label{ESchrodi2H}
  \left\{\Nabla^2+K^2-4\pi v(\r)-4\pi\v{b}(\r)\PauliVec\right\} \v\Psi(\r) = 0.
\end{equation}
\vspace*{-5pt}}
The plane-wave states \cref{EplaneWave} get an additional polarization index~$\alpha$,
\begin{equation}\label{EPlaneWave}
  \Psi_{\k\alpha}(\r)\coloneqq\hu_{\alpha}\e^{i\k\r},
\end{equation}
with possible polarizations given by the unit vectors $\hu_\alpha$.
...
\def\Ef{\v{E}_\sf}
\def\Efc{\Ef^*}
\def\Eo{\v{E}_0}%\overset{o}{\v{E}}}}
\def\Efo{\v{E}_{0\sf}}%\Eo_\sf}
\def\Efoc{\v{E}^*_{0\sf}}%\Eo\vphantom{E}^*_\sf}
%\def\EA{{\v{\cal E}}}
\def\he{\v{\hat e}}
\def\hef{\he_\sf}
\def\hei{\he_\si}
