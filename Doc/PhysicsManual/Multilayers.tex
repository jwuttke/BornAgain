...
Here the customary distinction of $s$ and $p$ polarization comes in.
It usually refers to the scattering plane, spanned by
the incoming and outgoing wavevectors $\k_\si$ and~$\k_\sf$.
In grazing-incidence and reflectometry experiments, however, it rather refers
to the incidence place spanned by $\k_\si$ and the sample normal~$\hz$.
